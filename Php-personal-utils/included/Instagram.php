...
class Instagram
{
    ...
    public function getMedias($username, $count = 20, $maxId = '')
    {
        ...
        public function getMediasAfter($username, $count = 24, $after = 12, $maxId = '')
    {

        $account = $this->getAccount($username);
        return $this->getMediasByUserIdAfter($account->getId(), $count, $after, $maxId);
    }
    ...
    public function getMediasByUserIdAfter($id, $count = 24, $after = 12, $maxId = '')
    {
        $index = $after;
        $medias = [];
        $isMoreAvailable = true;
